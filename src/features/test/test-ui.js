    ...
    if (infoEl) {
        ...
        infoEl.innerHTML = `
            ...
            <div class="test-bottom-actions">
                <button type="button" class="test-action-btn home-btn" id="testHomeBtn" title="${t('go_home') || 'Home'}">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                        <polyline points="9 22 9 12 15 12 15 22"></polyline>
                    </svg>
                    <span>${t('go_home') || 'Home'}</span>
                </button>
                <button type="button" class="test-action-btn edit-btn" id="testEditQuestionBtn" title="${t('edit') || 'Edit'}">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button type="button" class="test-action-btn exit-btn" id="scrollSummaryBtn" title="${t('exit') || 'Finish Test'}" style="display: ${hasInteraction ? 'inline-flex' : 'none'};">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
